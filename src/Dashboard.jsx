...
const MODULOS = [
  ...
  { id: "radar_demanda", nombre: "Radar de Demanda", icono: RadioTower, disponible: true, modulo: "radar_demanda", permiso: ["ver_radar_demanda", "registrar_demanda", "ver_resumen_demanda"] },
